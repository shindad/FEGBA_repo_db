...
function animCreate(category, feClass, anName, URL, dlName, srcName) {
    db.Anim.create({
        category: category,
        feClass: feClass,
        anName: anName,
...
// INSERT INTO anims (category, feClass, anName, URL, dlName, srcName) VALUES (
//     "sword", "Assassin", "Assassin F", "https://github.com/shindad/FEGBA_Anim/blob/master/feugit/assets/images/swords/assassin/f_gt.7z", "Assassin_F_GRT.7z", "Greentea, DerTheVaporeon"
// );

//animCreate("sword", "Assassin", "Assassin F", path + "swords/assassin/f_gt.7z", "Assassin_F_GRT.7z", "Greentea, DerTheVaporeon")
